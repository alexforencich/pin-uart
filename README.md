...
The build is scripted to generate the top-level HDL and pin constraint files based on the device pins.  Currently, the tool is a bit rough - only Vivado is supported, and the clocking configuration only supports STARTUPE3.
